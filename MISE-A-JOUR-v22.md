...
## Horodatage à la seconde

Les dates du journal étaient déjà enregistrées à la seconde près, mais Google
Sheets n'affichait que le jour. Les colonnes portent maintenant le format
complet :

- JOURNAL, colonnes HORODATAGE et MOMENT : `26/09/2026 13:42:07`
- DEVIS, colonne RECU_LE : `26/09/2026 13:42`

Le format est posé par *Devis → 6. Mettre à jour la structure du fichier*, et
s'applique aussi aux lignes déjà présentes.
